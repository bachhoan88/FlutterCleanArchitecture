...
class CategoryViewHolder extends BaseViewHolder<MovieItem> {
  CategoryViewHolder(MovieItem movieItem, Function(MovieItem) actionOnItemClicked) : super(movieItem, actionOnItemClicked);
